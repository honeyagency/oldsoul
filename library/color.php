...
class GetMostCommonColors
{
     ...
     * @return array
     */
    public function Get_Color($img, $count = 20, $reduce_brightness = true, $reduce_gradients = true, $delta = 16)
    {
        if (is_readable($img)) {
            if ($delta > 2) {
    ...
    public function _normalize($hex, $hexarray, $delta)
    {
        $lowest          = 255;
        $highest         = 0;
    ...
    public function _find_adjacent($hex, $gradients, $delta)
    {
