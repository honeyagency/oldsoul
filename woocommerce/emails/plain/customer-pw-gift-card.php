...
echo sprintf( __( '%s Gift Certificate', 'pw-woocommerce-gift-cards' ), get_option( 'blogname' ) ) . "\n";
echo sprintf( __( 'Amount: %s', 'pw-woocommerce-gift-cards' ), $pw_gift_cards->pretty_price( $item_data->amount ) ) . "\n";
echo sprintf( __( 'Gift Certificate number: %s', 'pw-woocommerce-gift-cards' ), $item_data->gift_card_number ) . "\n";
